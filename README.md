...
- **Prose** — written register, concrete over abstract, the thesis stated plainly, and nothing the reader cannot resolve from the piece in front of them; hedging is a posture toward the reader's territory, not a house style.
...
- **文字**：书面语，具体胜于空泛，论点直陈，且不留读者无从索解之处；试探语气仅用于涉及读者职权之处，而非全文的默认腔调。
